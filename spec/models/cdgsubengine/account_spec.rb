...
describe Cdgsubengine::Account do
  ...
  it "creates a schema" do
    account = Cdgsubengine::Account.create!({
      :name => "First Account",
      :subdomain => "first"
    })
  ...
  it "can be created with an owner" do
    ...
    account = Cdgsubengine::Account.create_with_owner(params)
  ...
  it "cannot create an account without a subdomain" do
    account = Cdgsubengine::Account.create_with_owner
