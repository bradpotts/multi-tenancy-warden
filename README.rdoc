...
=== CDG-SUBEngine
This engine takes the tedious task out of building an authetication and multi-tenancy system for rails projects.
...
===== Step 3: Add contraints to routes that requires login/multitenancy function in between the two lines below . (routes.rb)
