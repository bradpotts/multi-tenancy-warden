...
* Remote - gem 'cdgsubengine', git: 'http://github.com/CoastDigitalGroup/cdg-subengine.git'
* Local - gem 'cdgsubengine', path: 'cdgsubengine' (download into root project folder)
